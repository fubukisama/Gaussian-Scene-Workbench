...
- [3DGS Editor 0.1.0 Windows x64](https://github.com/fubukisama/3DGS-Editor/releases/tag/v0.1.0)
- 文件：`3DGS-Editor-0.1.0-win-x64.zip`
- SHA256：见 Release 里的 `3DGS-Editor-0.1.0-win-x64.zip.sha256`

zip 安装包没有提交进 git，因为它超过 GitHub 常规文件大小限制。请从 Release 下载发行包。

### 快速开始

1. 下载并解压 `3DGS-Editor-0.1.0-win-x64.zip`。
...
- [3DGS Editor 0.1.0 Windows x64](https://github.com/fubukisama/3DGS-Editor/releases/tag/v0.1.0)
- ファイル：`3DGS-Editor-0.1.0-win-x64.zip`
- SHA256：Release の `3DGS-Editor-0.1.0-win-x64.zip.sha256` を確認してください。

zip は GitHub の通常ファイルサイズ制限を超えるため、git にはコミットしていません。配布には Release アセットを使用してください。

### クイックスタート

1. `3DGS-Editor-0.1.0-win-x64.zip` をダウンロードして展開します。
