...
2. P1: camera visualization, brush/GPU ID selection, real Gaussian rendering, and crop-volume tools. Rectangle/lasso editing and lossless cropped PLY export are complete.
