...
- Persistent orthographic navigation: free canvas orbit, the navigation gizmo, pan, and wheel zoom preserve the selected projection; only explicit projection, camera-view, and reset commands change it.
