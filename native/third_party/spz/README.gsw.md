...
- Export v4 and v3; import standard v1–v4. This is lossy delivery, not optimizer checkpoint storage. The existing rendering pipeline currently displays DC SH; retained higher-degree SH is available for re-export and external renderers.
